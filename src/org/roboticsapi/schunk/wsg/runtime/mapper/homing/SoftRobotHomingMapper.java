...
public class SoftRobotHomingMapper implements ActionMapper<SoftRobotRuntime, Homing> {

	@Override
	public ActionMapperResult map(SoftRobotRuntime runtime, Homing action, DeviceParameterBag parameters,
			ActionMappingContext ports) throws MappingException, RPIException {

		return new GoalActionMapperResult(action, new NetFragment("Homing"),
				new HomingActionResult(action.getDirection()));
	}
