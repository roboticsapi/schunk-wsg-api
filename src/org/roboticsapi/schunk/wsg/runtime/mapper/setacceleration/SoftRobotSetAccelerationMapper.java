...
public class SoftRobotSetAccelerationMapper implements ActionMapper<SoftRobotRuntime, SetAcceleration> {

	@Override
	public ActionMapperResult map(SoftRobotRuntime runtime, SetAcceleration action, DeviceParameterBag parameters,
			ActionMappingContext ports) throws MappingException, RPIException {

		return new GoalActionMapperResult(action, new NetFragment("SetAcceleration"),
				new SetAccelerationActionResult(action.getAcceleration()));
	}
