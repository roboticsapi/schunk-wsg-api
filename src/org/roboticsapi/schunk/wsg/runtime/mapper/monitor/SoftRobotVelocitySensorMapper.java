...
public class SoftRobotVelocitySensorMapper
		implements SensorMapper<SoftRobotRuntime, Double, AbstractSoftRobotWSG50Driver.VelocitySensor> {

	@Override
	public SensorMapperResult<Double> map(final SoftRobotRuntime runtime,
			final AbstractSoftRobotWSG50Driver.VelocitySensor sensor, SensorMappingPorts ports,
