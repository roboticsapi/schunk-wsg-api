...
public class SoftRobotOpeningWidthSensorMapper
		implements SensorMapper<SoftRobotRuntime, Double, AbstractSoftRobotWSG50Driver.OpeningWidthSensor> {

	@Override
	public SensorMapperResult<Double> map(final SoftRobotRuntime runtime,
			final AbstractSoftRobotWSG50Driver.OpeningWidthSensor sensor, SensorMappingPorts ports,
		...
		DataflowOutPort port = ret.addOutPort(new DoubleDataflow(), true, m.getOutOpeningWidth());
