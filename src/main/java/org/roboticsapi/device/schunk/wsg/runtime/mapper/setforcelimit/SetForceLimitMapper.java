...
public class SetForceLimitMapper implements ActionMapper<SetForceLimit> {

	@Override
	public ActionResult map(SetForceLimit action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {
		return new SetForceLimitActionResult(action, RealtimeBoolean.TRUE, action.getForce());
	}
